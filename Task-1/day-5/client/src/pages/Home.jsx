...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {editingItem && (
        <ItemModal item={editingItem} onSave={handleSaveItem} onClose={() => setEditingItem(null)} />
      )}
      ...
      {confirmModal.show && (
        <ConfirmModal
          ...
          onConfirm={confirmModal.type === 'folder' ? confirmDeleteFolder : confirmMoveToTrash}
          onCancel={() => setConfirmModal({ show: false, type: '', data: null })}
        />
      )}
    </div>
  );
